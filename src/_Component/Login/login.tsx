  ...
  return (
    <main className="bg-white h-[100dvh] text-[#242323] flex justify-center items-center ">
      <section className="m-auto flex justify-center items-center sm:p-0 p-2 w-full">
        <form className="p-5 bg-white rounded-lg drop-shadow-2xl w-full max-w-sm">
          ...
          <div className="flex flex-col gap-5 text-sm">
            ...
            <a className="bg-blue-500 text-white py-2 w-full self-center rounded-sm text-sm text-center hover:shadow-md" href="/Dashboard">
              Sign In
            </a>
